...
class CompetenciasController extends Controller
{
    public function index()
    {
        ...
        return view('cargos.competencias.index', compact('permissoes'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $query = DB::table('cargos_competencias')->whereNull('deleted_at');
        ...
        return view('cargos.competencias.partials.table', compact('dados', 'permissoes'))->render();
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('cargos_competencias')->insert([
            'descricao' => trim($request->descricao),
            'created_at' => now(),
            'updated_at' => now(),
        ]);

        return response()->json(['success' => true, 'message' => 'Competência salva com sucesso.']);
    }
    ...
    public function edit($id)
    {
        ...
        $registro = DB::table('cargos_competencias')->where('id', $id)->whereNull('deleted_at')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Competência atualizada com sucesso.']);
    }
    ...
    public function delete($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Competência excluída com sucesso.']);
    }
    ...
    private function getPermissoes(): array
    {
        ...
        $registro = DB::table('vinculo_permissao_x_tela')
            ...
            ->where('gestao_tela.slug', 'cargos/competencias')
            ->select(
