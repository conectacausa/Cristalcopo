...
class ResponsabilidadesController extends Controller
{
    public function index()
    {
        ...
        return view('cargos.responsabilidades.index', compact('permissoes'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $query = DB::table('cargos_responsabilidades')->whereNull('deleted_at');
        ...
        return view('cargos.responsabilidades.partials.table', compact('dados', 'permissoes'))->render();
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('cargos_responsabilidades')->insert([
            'descricao' => trim($request->descricao),
            'created_at' => now(),
            'updated_at' => now(),
        ]);

        return response()->json(['success' => true, 'message' => 'Responsabilidade salva com sucesso.']);
    }
    ...
    public function edit($id)
    {
        ...
        $registro = DB::table('cargos_responsabilidades')->where('id', $id)->whereNull('deleted_at')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('cargos_responsabilidades')
            ->where('id', $id)
        ...
        return response()->json(['success' => true, 'message' => 'Responsabilidade atualizada com sucesso.']);
    }
    ...
    public function delete($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Responsabilidade excluída com sucesso.']);
    }
    ...
    private function getPermissoes(): array
    {
        ...
        $registro = DB::table('vinculo_permissao_x_tela')
            ...
            ->where('gestao_tela.slug', 'cargos/responsabilidades')
            ->select(
