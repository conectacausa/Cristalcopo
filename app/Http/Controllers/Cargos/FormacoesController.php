...
class FormacoesController extends Controller
{
    public function index()
    {
        ...
        return view('cargos.formacao.index', compact('permissoes'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $query = DB::table('cargos_formacoes')->whereNull('deleted_at');
        ...
        return view('cargos.formacao.partials.table', compact('dados', 'permissoes'))->render();
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('cargos_formacoes')->insert([
            'descricao' => trim($request->descricao),
            'created_at' => now(),
            'updated_at' => now(),
        ]);

        return response()->json(['success' => true, 'message' => 'Formação salva com sucesso.']);
    }
    ...
    public function edit($id)
    {
        ...
        $registro = DB::table('cargos_formacoes')->where('id', $id)->whereNull('deleted_at')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Formação atualizada com sucesso.']);
    }
    ...
    public function delete($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Formação excluída com sucesso.']);
    }
    ...
    private function getPermissoes(): array
    {
        ...
        $registro = DB::table('vinculo_permissao_x_tela')
            ...
            ->where('gestao_tela.slug', 'cargos/formacao')
            ->select(
